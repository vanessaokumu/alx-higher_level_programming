...
class TestBaseClass(unittest.TestCase):
    ...
    def test_output(self):
        ...
        with patch('sys.stdout', new=StringIO()) as fake_out:
            ...
            self.assertEqual(fake_out.get_value().strip(), expected_output)
    ...
    def test_base_methods.doc(self):
        """docstring exists for all methods"""
    ...
    def test_class_var_exist(self):
        """check if class variable has value after instantiation"""
        self.assertIsNotNone(Base.__Base__nb_objects)
    ...
    def test_base_methods(self):
        """check for method that exists in base"""
    ...
    def test_create(self):
        ...
        self.assertIsNotNone9self.rt2.__dict__)
